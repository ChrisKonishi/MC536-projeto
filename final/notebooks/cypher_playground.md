...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/ChrisKonishi/MC536-projeto/main/final/data/processed/countries_processed/countries.csv' AS line
CREATE (:PAIS {CODE: line.ALPHA3});
CREATE INDEX ON :PAIS(CODE);


LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/ChrisKonishi/MC536-projeto/main/final/data/processed/cypher/happiness_norm.csv' AS LINE
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/ChrisKonishi/MC536-projeto/main/final/data/processed/cypher/pais_indice.csv' AS LINE
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/ChrisKonishi/MC536-projeto/main/final/data/processed/countries_processed/regions.csv' AS line
CREATE (:REGION {CODE: line.REGION});
CREATE INDEX ON :REGION(CODE);

LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/ChrisKonishi/MC536-projeto/main/final/data/processed/countries_processed/subregions.csv' AS line
